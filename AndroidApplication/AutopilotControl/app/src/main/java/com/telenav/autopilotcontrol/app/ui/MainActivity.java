...
public class MainActivity  extends AppCompatActivity {
    ...
    Button swipeStartScreen;
    Button swipeControlScreen;
    Button autoSwap;
    GLSurfaceView gl;
    ...
    {
        //swipeControlScreen = new Button(this);
        swipeControlScreen = (Button) findViewById(R.id.SwipeControlScreen);
        swipeStartScreen = (Button) findViewById(R.id.SwipeStartScreen);
        autoSwap = (Button) findViewById(R.id.AutoSwap);
//        PerceptionNotWorking = (TextView) findViewById(R.id.node_not_working_middle);
//        otherNodesNotWorking = (TextView) findViewById(R.id.node_not_working_top);

        RelativeLayout leftLayout = (RelativeLayout) findViewById(R.id.leftPane);
        ...
        swipeControlScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                screenView = controlScreen;
                autoswap = false;
                autoSwap.setBackgroundResource(R.drawable.autoswap_disabled);
                areWeOnStartScreen = false;


            }
        });

        swipeStartScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                screenView = startScreen;
                autoswap = false;
                autoSwap.setBackgroundResource(R.drawable.autoswap_disabled);
                areWeOnStartScreen = true;
            }
        });

        autoSwap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                autoswap = true;
                autoSwap.setBackgroundResource(R.drawable.autoswap_enabled);
...
//                }
    ...
    private void attachFragmentToActivity() {
        ...
        getFragmentManager().beginTransaction().replace(R.id.leftPane, animateFragment, ANIMATE_FRAGMENT).commit();
